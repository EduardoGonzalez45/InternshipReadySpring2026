...
with st.sidebar:
    ...
    if uploaded_file_ui and "doc_ref" not in st.session_state:
        with st.spinner("Uploading your document..."):
            ...
            with open("temp_doc", "wb") as f: # temp_doc file created w/ writing capabilities.
...
if "messages" not in st.session_state:
    st.session_state.messages = [] # creating a list of dictionaries
    # where each dictionary is a message containing role and content

for msg in st.session_state.messages: # iterate through the list of documentaries
...
if prompt:
    ...
    with st.chat_message("assistant"):
        ...
        st.session_state.messages.append({"role":"assistant","content":response.txt})